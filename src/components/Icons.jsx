...
const IWalks = ({ s = 24 }) => (
  <svg {...g(s)}>
    <path d="M5 16.5h12.5l1.5 1.8v1.7H4.2v-1.4c0-1.2.9-2.1 2.1-2.1H9" />
    <path d="M9 16.5V9.8c0-1.2 1-2.2 2.2-2.2h2l1.8 2h2.5c1 0 1.8.8 1.8 1.8v2.4" />
    <path d="M13.2 7.6V5.8" />
    <path d="M6.2 13.3c1.4-1 3.1-1.6 4.8-1.6" />
    <path d="M5 6.6h1.6M3.8 9.4h2.3M2.8 12.2h2.7" />
  </svg>
);
const IEvent = ({ s = 24 }) => (
  <svg {...g(s)}>
