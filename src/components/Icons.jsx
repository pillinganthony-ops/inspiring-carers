...
const IWalks = ({ s = 24 }) => (
  <svg {...g(s)} strokeWidth="2.1">
    <path d="M4.6 16.4h12.9l1.9 2.1v1.7H3.8v-1.2c0-1.4 1.1-2.6 2.6-2.6h2.5" />
    <path d="M8.9 16.4V9.3c0-1.3 1-2.3 2.3-2.3h2.3l1.8 2.1h2.2c1.1 0 2 .9 2 2v2.8" />
    <path d="M13.4 7V5.2" />
    <path d="M5.2 14.1c1.5-1.1 3.4-1.7 5.4-1.7" />
    <path d="M4.5 6.4h1.8M3.4 9.6h2.5M2.8 12.6h2.8" />
    <path d="M15.8 13.6c.8.7 1.7 1.1 2.8 1.2" />
  </svg>
);
const IEvent = ({ s = 24 }) => (
  <svg {...g(s)}>
